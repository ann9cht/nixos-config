...
local file = _G.file or "nautilus"
local browser = _G.browser or "firefox"
local editor = _G.editor or "codium"
...
hl.bind("SUPER + SHIFT + S", hl.dsp.exec_cmd("serpantinum screenshot --edit"), { locked = true })
hl.bind("SUPER + Print", hl.dsp.exec_cmd("serpantinum screenshot --full"), { locked = true })
hl.bind("SUPER + P", hl.dsp.exec_cmd("serpantinum screenshot --full"), { locked = true })
hl.bind("SUPER + SHIFT + Print", hl.dsp.exec_cmd("serpantinum screenshot --full --edit"), { locked = true })
hl.bind("SUPER + SHIFT + P", hl.dsp.exec_cmd("serpantinum screenshot --full --edit"), { locked = true })
...
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
...
hl.bind(mainMod .. " + ALT + E", hl.dsp.exec_cmd("[float; size 800 600; center; animation popin] nautilus"))
